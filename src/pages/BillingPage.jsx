...
export default function BillingPage() {
  ...
  const plans = [{
    ...
    features: ['2 Active Agents', 'Basic Market Analysis', 'Portfolio Tracking', 'Email Support'],
    mostPopular: false
  }, {
    id: 'professional',
    name: 'Professional',
    ...
    features: ['10 Active Agents', 'Advanced Trading Strategies', 'Real-time Market Alerts', 'Priority Support', 'Team Collaboration'],
    mostPopular: true
  }, {
    id: 'enterprise',
    name: 'Enterprise',
    ...
    features: ['Unlimited Active Agents', 'Custom Strategy Development', 'API Access', 'Dedicated Account Manager', 'Exchange Integration', 'Premium Data Sources'],
    mostPopular: false
  }];
  const invoices = [{
    id: 'INV-001',
          ...
          <TabsContent value="plans" className="space-y-6 pt-4">
              ...
              <CardContent className="space-y-4">
                <div className="flex justify-between items-start">
                  <div>
                    <h3 className="text-xl font-bold">
                      ...
                      {currentPlanData.mostPopular && <Badge variant="secondary" className="ml-2">
                          Most Popular
                        </Badge>}
                    </h3>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    {currentPlanData.features.map((feature, index) => <div key={index} className="flex items-center gap-2">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {plans.map(plan => <Card key={plan.id} className={`${plan.id === currentPlan ? 'border-primary' : ''} ${plan.mostPopular ? 'relative' : ''}`}>
                    {plan.mostPopular && <div className="absolute top-0 right-0 bg-primary text-primary-foreground px-3 py-1 text-xs font-medium">
                        MOST POPULAR
                      </div>}
                    <CardHeader>
                      ...
                      <div className="mt-1">
                        {plan.price !== null ? <>
                          ...
                          </> : <span className="text-xl font-bold">Custom
                    </span>}
                      </div>
                    ...
                    <CardFooter>
                      {plan.id === currentPlan ? <Button className="w-full" disabled>Current Plan</Button> : <Button className="w-full" variant={plan.id === "enterprise" ? "outline" : "default"} onClick={() => handleSwitchPlan(plan.id)}>
                ...
                <div className="overflow-x-auto">
                  <table className="w-full text-sm">
                    ...
                    <tbody className="divide-y divide-border">
                      {invoices.map(invoice => <tr key={invoice.id} className="hover:bg-muted/50">
